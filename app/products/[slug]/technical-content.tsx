...
export const TechnicalContent = () => {
  return (
    <div className="flex flex-col gap-[50px] px-6 md:px-10 w-full container mx-auto font-medium">
      <div className="flex flex-col gap-[50px] pt-9">
        <h3 className="text-primary text-[25px]">Technical Data Sheet</h3>
        <div className="flex gap-20 text-xl border-dashed border border-[#021207CC] p-5 w-fit items-center">
          <span>
            No Technical Data Sheets are available for this material.{" "}
      ...
      <div className="flex flex-col gap-[50px]">
        <h3 className="text-primary text-[25px]">Safety Data Sheet</h3>
        <div className="flex gap-20 text-xl border-dashed border border-[#021207CC] p-5 w-fit items-center">
          <span>
            No Safety Data Sheets are available for this material.{" "}
            <Link href="/" className="font-semibold text-primary">
                Please contact us
            </Link>
          </span>
      ...
      <div className="flex flex-col gap-[50px]">
        <h3 className="text-primary text-[25px]">Regularly Data Sheet</h3>
        <div className="flex gap-20 text-xl border-dashed border border-[#021207CC] p-5 w-fit items-center">
          <span>
            No Regulatory Data Sheets are available for this material.{" "}
            <Link href="/" className="font-semibold text-primary">
                Please contact us
            </Link>
          </span>

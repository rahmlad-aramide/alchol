...
const SustainableEnergy = () => {
  ...
  return (
    <section>
        <p className='font-bold text-[50px]/[100%] font-[family-name:var(--font-alumni-sans)] py-[50px] max-w-[1440px] px-6 md:px-10'>
            <span className='underline-sustainable underline-sustainable2'>Sustainable</span> Energy
        </p>
        <div className='py-20 bg-(image:--sustainable-energy) bg-[#29A64C4D] bg-blend-overlay bg-center bg-cover'>
            <div className='flex flex-wrap justify-center items-center gap-x-[45px] gap-y-[60px] px-6 md:px-10 w-full max-w-[1440px] mx-auto'>
                {sustainableEnergyData.map((energy, idx)=> (
                <div key={idx} className='bg-white relative w-full max-w-[350px] h-fit min-h-[227px] rounded-[10px] flex flex-col gap-2.5 pb-4'>
                    ...
                    <h3 className={`font-[family-name:var(--font-alumni-sans)] font-bold text-4xl text-primary p-6 text-center ${idx === 0? 'max-w-[12ch]': 'max-w-[19ch]'} mx-auto`}>{energy.source}</h3>

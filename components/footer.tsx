    ...
    <footer className='bg-[#0B6A26] text-[#FCFCFCE5]'>
            <div className='flex px-6 md:px-10 w-full max-w-[1440px] mx-auto gap-[108px] py-[100px]'>
                <div className='flex flex-col gap-5'>
                    <Image src={logoWhite} width={148} height={48} alt='Alchol White Logo' />
                    <p>Innovative, Economical,
                    Sustainable...</p>
                </div>
                <div className='flex flex-col gap-7.5'>
                    ...
                    <div className='flex flex-col gap-5'>
                        ...
                        Lagos State,
                        Nigeria</p>
                        <Link href={'mailto:info@alcholchemicals.com'}>info@alcholchemicals.com</Link>
